...
const Footer = () => {
    return (
        <footer className="border-t border-gray-800 bg-[#1A1A2E] py-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-6 md:mb-0">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h2 className="text-xl font-bold text-white">WorkVista</h2>
                        </div>
                        <p className="text-gray-400 text-sm">© 2025 WorkVista. All rights reserved.</p>
                    </div>

                    {/* Trusted Companies Section */}
                    <div className="text-center mb-6 md:mb-0">
                        <p className="text-gray-400 text-sm mb-3">Trusted by professionals from:</p>
                        <div className="flex flex-wrap justify-center gap-3">
                            {['Google', 'Microsoft', 'Apple', 'Amazon', 'Meta', 'Netflix'].map((company) => (
                                <span 
                                    key={company}
                                    className="px-3 py-1 bg-gray-800 text-white text-xs rounded-lg border border-gray-700"
                                >
                                    {company}
                                </span>
                            ))}
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 bg-gray-800 rounded-lg border border-gray-700">
                        ...
                        <span className="text-white text-sm">Available in 50+ countries</span>
                    </div>
                </div>
